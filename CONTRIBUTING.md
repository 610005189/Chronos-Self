...
Chronos-Self 是一个基于 PyTorch 的自感知连续时间认知架构，旨在构建具有自我感知能力的人工智能系统。项目核心特性包括：

- **7 大核心子系统**：表征系统、积分引擎、默认模式网络、元认知调控、反思系统、记忆系统、验证系统
- **双通道表征与交叉融合**：语义与本体感觉双通道编码，多层级交叉融合
- **多时间尺度连续积分**：基于神经 ODE 的快慢动力学耦合
- **内源性 DMN**：混沌吸引子驱动的默认模式网络
- **层级化元认知**：感知-自我状态-元认知三层自指调控
- **反思与睡眠重放**：实时反思与离线巩固机制
